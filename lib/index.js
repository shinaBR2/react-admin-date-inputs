...
var makePicker = function makePicker(PickerComponent) {
    var _makePicker = function _makePicker(_ref2) {
        var _ref2$format = _ref2.format,
            ...
            value = _ref2.value,
            rest = _objectWithoutProperties(_ref2, ['format', 'label', 'options', 'source', 'resource', 'helperText', 'margin', 'onBlur', 'onChange', 'onFocus', 'parse', 'validate', 'variant', 'defaultValue', 'providerOptions', 'pickerVariant', 'value']);

...
var sanitizeRestProps = function sanitizeRestProps(_ref) {
    var allowEmpty = _ref.allowEmpty,
        ...
        rest = _objectWithoutProperties(_ref, ['allowEmpty', 'alwaysOn', 'basePath', 'component', 'defaultValue', 'formClassName', 'initialValue', 'initializeForm', 'input', 'isRequired', 'label', 'limitChoicesToValue', 'locale', 'meta', 'options', 'optionText', 'optionValue', 'record', 'resource', 'source', 'textAlign', 'translate', 'translateChoice', 'labelTime']);
...
var makePicker = function makePicker(PickerComponent) {
    var _makePicker = function _makePicker(_ref2) {
        var _ref2$format = _ref2.format,
            format = _ref2$format === undefined ? format : _ref2$format,
            label = _ref2.label,
            ...
            parse = _ref2$parse === undefined ? parse : _ref2$parse,
